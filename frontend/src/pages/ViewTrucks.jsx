...
function ViewTrucks() {
  ...
  return (
    <div className="container mt-4 position-relative">
      ...
      {loading ? (
        <p className="trucks-loading">Loading trucks...</p>
      ) : (
        <div className="row g-4">
          ...
          {filteredTrucks.length === 0 && !loading && (
            <p className="trucks-loading">No trucks found.</p>
          )}
        </div>
      )}
      ...
      {showConfirm && (
        ...
        >
          <div className="rounded p-4 shadow trucks-confirm-modal" style={{ maxWidth: "400px", width: "100%" }}>
            ...
            <div className="d-flex justify-content-end">
              <button className="edit-truck-btn-cancel me-2" onClick={() => setShowConfirm(false)}>
                Cancel
              </button>
              <button
